  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none opacity-50 transition-opacity select-none group-hover:opacity-40">
          {children}
        </div>

        {/* Lock overlay */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-card/90 border-primary/20 flex items-center gap-1.5 rounded-lg border px-2.5 py-1 shadow-sm backdrop-blur-sm">
            <Lock className="text-primary h-3 w-3" />
            {showLabel && (
              <span className="text-primary text-xs font-semibold">Pro</span>
            )}
          </div>
        </div>
      </div>
