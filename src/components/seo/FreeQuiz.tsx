        ...
        <div className="seo-quiz">
            ...
            <div className="seo-quiz__options">
                {q.options.map((opt, i) => {
                    ...
                    if (answered && i === q.correctIndex) cls += ' seo-quiz__option--correct';
                    else if (answered && i === selected) cls += ' seo-quiz__option--wrong';
                    else if (!answered && i === selected) cls += ' seo-quiz__option--selected';
            ...
            {answered && (
                <div className="seo-quiz__explanation">{q.explanation}</div>
            )}

            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
                {!answered ? (
                    <button type="button" className="seo-quiz__btn" disabled={selected === null} onClick={handleCheck}>
                        Check Answer
                    </button>
                ) : (
