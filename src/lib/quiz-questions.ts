...
const CISSP_QUESTIONS: QuizQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The principle of least privilege states that users should be granted only the minimum access necessary to perform their job duties. This reduces the attack surface and limits potential damage from compromised accounts.',
  },
  {
    id: 'cissp-q2',
    ...
    correctIndex: 2,
    explanation:
      'Risk appetite — the level of risk an organization is willing to accept — is a strategic business decision that must be defined by senior management or the Board of Directors, not by technical staff.',
  },
  {
    id: 'cissp-q3',
    ...
    correctIndex: 2,
    explanation:
      'The Bell-LaPadula model focuses on data confidentiality. Its two main rules are: Simple Security (no read up) — a subject cannot read data at a higher classification; and Star Property (no write down) — a subject cannot write data to a lower classification.',
  },
  {
    id: 'cissp-q4',
    ...
    correctIndex: 1,
    explanation:
      'A BIA identifies critical business functions, assesses the impact of their disruption, and establishes recovery priorities. It forms the foundation for business continuity and disaster recovery planning.',
  },
  {
    id: 'cissp-q5',
    ...
    correctIndex: 2,
    explanation:
      'Symmetric encryption uses a single shared key for both encryption and decryption. It is generally faster than asymmetric encryption but presents the key distribution challenge.',
  },
  {
    id: 'cissp-q6',
    ...
    correctIndex: 2,
    explanation:
      'Traditional firewalls operate at the Network layer (Layer 3) for IP filtering and Transport layer (Layer 4) for port-based filtering. Next-generation firewalls also inspect at Layer 7 (Application).',
  },
  {
    id: 'cissp-q7',
    ...
    correctIndex: 1,
    explanation:
      'A vulnerability assessment identifies and categorizes security weaknesses without exploitation. A penetration test goes further by actively attempting to exploit vulnerabilities to determine the real-world impact.',
  },
  {
    id: 'cissp-q8',
    ...
    correctIndex: 2,
    explanation:
      'Recovery Time Objective (RTO) is the maximum acceptable time to restore a system or process after a disruption. RPO defines acceptable data loss, and MTD is the total time a process can be unavailable.',
  },
  {
    id: 'cissp-q9',
    ...
    correctIndex: 2,
    explanation:
      'Mandatory Access Control (MAC) uses security labels (classifications) on objects and clearances on subjects. Access decisions are made by the system based on these labels, not by individual users.',
  },
  {
    id: 'cissp-q10',
    ...
    correctIndex: 2,
    explanation:
      'Separation of duties divides critical tasks among multiple individuals so that no single person can complete a high-risk action alone. This is a key control for preventing fraud and errors.',
  },
];
...
const CC_QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      'Certified, Integrated, Authorized',
    ],
    correctIndex: 0,
    explanation:
      'The CIA triad (Confidentiality, Integrity, Availability) is the foundational model for information security, guiding policies and controls to protect information assets.',
  },
  {
    id: 'cc-q2',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'A firewall monitors and filters incoming and outgoing network traffic based on security rules, acting as a barrier between trusted and untrusted networks.',
  },
  {
    id: 'cc-q4',
    ...
    correctIndex: 2,
    explanation:
      'Multi-factor authentication requires two or more different types of authentication factors: something you know (PIN), something you have (smart card), or something you are (biometrics).',
  },
  {
    id: 'cc-q5',
    ...
    correctIndex: 2,
    explanation:
      'Social engineering exploits human psychology — trust, fear, urgency — to trick people into revealing sensitive information or performing actions that compromise security.',
  },
];
