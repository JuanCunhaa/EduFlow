...
const CC: CertSeoData = {
  ...
  domains: [
    {
      ...
      metaDescription:
        'Study guide for ISC2 CC Domain 1 – Security Principles. CIA triad, authentication, authorization, and security concepts.',
      keyTopics: [
        'CIA triad',
    ...
    },
    {
      ...
      metaDescription:
        'Study guide for ISC2 CC Domain 2 – Business Continuity, Disaster Recovery, and Incident Response concepts.',
      keyTopics: [
    ...
    },
    {
      ...
      metaDescription:
        'Study guide for ISC2 CC Domain 3 – Access Controls. Physical and logical access, role-based access control, and least privilege.',
      keyTopics: [
    ...
    },
    {
      ...
      metaDescription:
        'Study guide for ISC2 CC Domain 4 – Network Security. Networking concepts, firewalls, VPNs, and wireless security.',
      keyTopics: [
    ...
    },
    {
      ...
      metaDescription:
        'Study guide for ISC2 CC Domain 5 – Security Operations. Data security, system hardening, and security policies.',
      keyTopics: [
  ...
  faqItems: [
    {
      question: 'What is the ISC2 CC certification?',
      answer:
        "The Certified in Cybersecurity (CC) is ISC2's entry-level certification. It requires no prior experience and covers 5 foundational security domains.",
    },
    {
      question: 'Is the CC exam free?',
      answer:
        'Yes, ISC2 currently offers the CC exam and training at no cost as part of their "One Million Certified in Cybersecurity" initiative.',
    },
    {
      question: 'How long should I study for CC?',
      answer:
        'Most candidates study for 2 to 4 weeks. The CC is designed for beginners, so the content is more accessible than CISSP or SSCP.',
    },
  ],
};
...
const SSCP: CertSeoData = {
  ...
  domains: [
    {
      slug: 'domain-1-security-operations-and-administration',
      name: 'Security Operations and Administration',
      domainNumber: 1,
      examWeight: '16%',
      metaTitle: 'SSCP Domain 1: Security Operations and Administration',
      metaDescription:
        'Study guide for SSCP Domain 1 – Security Operations and Administration.',
      keyTopics: [
    ...
    {
      slug: 'domain-2-access-controls',
      name: 'Access Controls',
      domainNumber: 2,
      examWeight: '15%',
      metaTitle: 'SSCP Domain 2: Access Controls',
      metaDescription: 'Study guide for SSCP Domain 2 – Access Controls.',
      keyTopics: [
    ...
    {
      slug: 'domain-3-risk-identification-monitoring-and-analysis',
      name: 'Risk Identification, Monitoring, and Analysis',
      domainNumber: 3,
      examWeight: '15%',
      metaTitle: 'SSCP Domain 3: Risk Identification, Monitoring, and Analysis',
      metaDescription:
        'Study guide for SSCP Domain 3 – Risk Identification, Monitoring, and Analysis.',
      keyTopics: [
        'Risk management',
        'Security assessment',
    ...
    {
      slug: 'domain-4-incident-response-and-recovery',
      name: 'Incident Response and Recovery',
      domainNumber: 4,
      examWeight: '14%',
      metaTitle: 'SSCP Domain 4: Incident Response and Recovery',
      metaDescription:
        'Study guide for SSCP Domain 4 – Incident Response and Recovery.',
      keyTopics: [
        'Incident handling',
        'Forensics support',
        'Business continuity',
    ...
    {
      slug: 'domain-5-cryptography',
      name: 'Cryptography',
      domainNumber: 5,
      examWeight: '9%',
      metaTitle: 'SSCP Domain 5: Cryptography',
      metaDescription: 'Study guide for SSCP Domain 5 – Cryptography.',
      keyTopics: [
    ...
    {
      slug: 'domain-6-network-and-communications-security',
      name: 'Network and Communications Security',
      domainNumber: 6,
      examWeight: '16%',
      metaTitle: 'SSCP Domain 6: Network and Communications Security',
      metaDescription:
        'Study guide for SSCP Domain 6 – Network and Communications Security.',
      keyTopics: [
        'Network fundamentals',
        'Network protocols',
        'Network attacks',
    ...
    {
      slug: 'domain-7-systems-and-application-security',
      name: 'Systems and Application Security',
      domainNumber: 7,
      examWeight: '15%',
      metaTitle: 'SSCP Domain 7: Systems and Application Security',
      metaDescription:
        'Study guide for SSCP Domain 7 – Systems and Application Security.',
      keyTopics: [
        'Malware protection',
        'Endpoint security',
        'Cloud security',
  ...
  faqItems: [
    {
      question: 'What is the SSCP certification?',
      answer:
        'The SSCP is an ISC2 certification for hands-on security practitioners. It covers 7 domains and requires 1 year of experience.',
    },
    {
      question: 'How does SSCP compare to CISSP?',
      answer:
        'SSCP is more technical and hands-on, while CISSP is broader and more managerial. SSCP requires 1 year experience vs 5 years for CISSP.',
    },
  ],
};
...
const CCSP: CertSeoData = {
  ...
  examDetails: {
    ...
    cost: '$599 USD',
    prerequisites:
      '5 years IT experience, 3 years in information security, 1 year in cloud security',
  },
  domains: [
    {
      slug: 'domain-1-cloud-concepts-architecture-and-design',
      name: 'Cloud Concepts, Architecture and Design',
      domainNumber: 1,
      examWeight: '17%',
      metaTitle: 'CCSP Domain 1: Cloud Concepts, Architecture and Design',
      metaDescription:
        'Study guide for CCSP Domain 1 – Cloud Concepts, Architecture and Design.',
      keyTopics: [
    ...
    {
      slug: 'domain-2-cloud-data-security',
      name: 'Cloud Data Security',
      domainNumber: 2,
      examWeight: '20%',
      metaTitle: 'CCSP Domain 2: Cloud Data Security',
      metaDescription: 'Study guide for CCSP Domain 2 – Cloud Data Security.',
      keyTopics: [
        'Data lifecycle',
    ...
    {
      slug: 'domain-3-cloud-platform-and-infrastructure-security',
      name: 'Cloud Platform and Infrastructure Security',
      domainNumber: 3,
      examWeight: '17%',
      metaTitle: 'CCSP Domain 3: Cloud Platform and Infrastructure Security',
      metaDescription:
        'Study guide for CCSP Domain 3 – Cloud Platform and Infrastructure Security.',
      keyTopics: [
    ...
    {
      slug: 'domain-4-cloud-application-security',
      name: 'Cloud Application Security',
      domainNumber: 4,
      examWeight: '17%',
      metaTitle: 'CCSP Domain 4: Cloud Application Security',
      metaDescription:
        'Study guide for CCSP Domain 4 – Cloud Application Security.',
      keyTopics: [
    ...
    {
      slug: 'domain-5-cloud-security-operations',
      name: 'Cloud Security Operations',
      domainNumber: 5,
      examWeight: '17%',
      metaTitle: 'CCSP Domain 5: Cloud Security Operations',
      metaDescription:
        'Study guide for CCSP Domain 5 – Cloud Security Operations.',
      keyTopics: [
    ...
    {
      slug: 'domain-6-legal-risk-and-compliance',
      name: 'Legal, Risk and Compliance',
      domainNumber: 6,
      examWeight: '12%',
      metaTitle: 'CCSP Domain 6: Legal, Risk and Compliance',
      metaDescription:
        'Study guide for CCSP Domain 6 – Legal, Risk and Compliance.',
      keyTopics: [
        'Legal requirements',
        'Privacy issues',
        'Audit processes',
  ...
  faqItems: [
    {
      question: 'What is the CCSP certification?',
      answer:
        'The CCSP is an ISC2 certification focused on cloud security. It covers 6 domains and is designed for experienced security professionals working with cloud environments.',
    },
    {
      question: 'Is CCSP harder than CISSP?',
      answer:
        'CCSP is more focused on cloud-specific topics while CISSP is broader. Many professionals find CCSP easier if they have cloud experience, but harder if their background is in traditional IT security.',
    },
  ],
};
...
const CGRC: CertSeoData = {
  ...
  domains: [
    {
      slug: 'domain-1-information-security-risk-management-program',
      name: 'Information Security Risk Management Program',
      domainNumber: 1,
      examWeight: '16%',
      metaTitle: 'CGRC Domain 1: Information Security Risk Management Program',
      metaDescription:
        'Study guide for CGRC Domain 1 – Information Security Risk Management Program.',
      keyTopics: [
    ...
    {
      slug: 'domain-2-scope-of-the-information-system',
      name: 'Scope of the Information System',
      domainNumber: 2,
      examWeight: '11%',
      metaTitle: 'CGRC Domain 2: Scope of the Information System',
      metaDescription:
        'Study guide for CGRC Domain 2 – Scope of the Information System.',
      keyTopics: [
        'System boundaries',
    ...
    {
      slug: 'domain-3-selection-and-approval-of-controls',
      name: 'Selection and Approval of Controls',
      domainNumber: 3,
      examWeight: '15%',
      metaTitle: 'CGRC Domain 3: Selection and Approval of Controls',
      metaDescription:
        'Study guide for CGRC Domain 3 – Selection and Approval of Controls.',
      keyTopics: [
        'Control selection',
        'Control baselines',
    ...
    {
      slug: 'domain-4-implementation-of-controls',
      name: 'Implementation of Controls',
      domainNumber: 4,
      examWeight: '15%',
      metaTitle: 'CGRC Domain 4: Implementation of Controls',
      metaDescription:
        'Study guide for CGRC Domain 4 – Implementation of Controls.',
      keyTopics: [
    ...
    {
      slug: 'domain-5-assessment-audit-of-controls',
      name: 'Assessment/Audit of Controls',
      domainNumber: 5,
      examWeight: '16%',
      metaTitle: 'CGRC Domain 5: Assessment/Audit of Controls',
      metaDescription:
        'Study guide for CGRC Domain 5 – Assessment/Audit of Controls.',
      keyTopics: [
        'Assessment planning',
        'Assessment methods',
        'Audit procedures',
    ...
    {
      slug: 'domain-6-authorization-approval-of-information-system',
      name: 'Authorization/Approval of Information System',
      domainNumber: 6,
      examWeight: '13%',
      metaTitle: 'CGRC Domain 6: Authorization/Approval of Information System',
      metaDescription:
        'Study guide for CGRC Domain 6 – Authorization/Approval of Information System.',
      keyTopics: [
    ...
    {
      slug: 'domain-7-continuous-monitoring',
      name: 'Continuous Monitoring',
      domainNumber: 7,
      examWeight: '14%',
      metaTitle: 'CGRC Domain 7: Continuous Monitoring',
      metaDescription: 'Study guide for CGRC Domain 7 – Continuous Monitoring.',
      keyTopics: [
        'Monitoring strategy',
  ...
  faqItems: [
    {
      question: 'What is the CGRC certification?',
      answer:
        'The CGRC (formerly CAP) is an ISC2 certification for professionals who authorize and maintain information systems with a focus on governance, risk, and compliance frameworks.',
    },
    {
      question: 'What is the difference between CGRC and CISSP?',
      answer:
        'CGRC is focused on GRC (governance, risk, and compliance) while CISSP is a broad cybersecurity management certification. CGRC requires 2 years experience vs 5 for CISSP.',
    },
  ],
};
  ...
  faqItems: [
    {
      ...
      answer:
        'CompTIA Security+ (SY0-701) is a globally recognized cybersecurity certification that validates baseline security skills. It is vendor-neutral and covers both technical and management security concepts.',
    },
    {
      question: 'How hard is Security+?',
      answer:
        'Security+ is considered an entry-to-mid level certification. With structured study over 4-8 weeks, most candidates with basic IT knowledge can pass. The pass rate is estimated around 70-80%.',
    },
    {
      question: 'Do I need experience for Security+?',
      answer:
        'No experience is required, though CompTIA recommends at least 2 years of IT experience with a security focus. Many candidates pass without prior security experience.',
    },
    {
      question: 'What is the Security+ SY0-701 exam format?',
      answer:
        'The SY0-701 exam has up to 90 questions (multiple-choice and performance-based), a 90-minute time limit, and requires a score of 750/900 to pass. The exam costs $404 USD.',
    },
    {
      question: 'Is Security+ or CISSP better?',
      answer:
        'They serve different career stages. Security+ is entry-level and requires no experience, making it ideal for starting your cybersecurity career. CISSP requires 5 years experience and targets senior/management roles. Many professionals get Security+ first, then CISSP later.',
    },
  ],
};
...
export const CERTS: CertSeoData[] = [
  CISSP,
  CC,
  SSCP,
  CCSP,
