...
const KNOWN_CERTS: Record<string, KnownCertInfo> = {
    ...
    cisa: {
        ...
        domains: [
            ...
            { id: 'isd', name: 'Information Systems Acquisition, Development and Implementation', weight: '12%', topics: ['project governance', 'project management', 'IS development methodologies', 'IS maintenance'] },
            { id: 'iso', name: 'Information Systems Operations and Business Resilience', weight: '26%', topics: ['IS operations', 'hardware', 'IS architecture', 'data governance', 'BCP/DRP'] },
    ...
    cism: {
        ...
        domains: [
            ...
            { id: 'isdm', name: 'Information Security Program Development and Management', weight: '33%', topics: ['program development', 'program management', 'program resources', 'security architectures'] },
            { id: 'isim', name: 'Information Security Incident Management', weight: '30%', topics: ['incident classification', 'incident management', 'investigation', 'response planning', 'recovery'] },
        ],
    },
    'aws-saa': {
        slug: 'aws-saa',
    ...
    'az-900': {
        ...
        domains: [
            ...
            { id: 'as', name: 'Azure Security', weight: '10%', topics: ['Azure AD', 'MFA', 'RBAC', 'Azure Policy', 'network security'] },
        ],
    },
};
...
const CERT_ALIASES: Record<string, string> = {
    'cissp': 'cissp', 'cc': 'cc', 'sscp': 'sscp', 'ccsp': 'ccsp',
    'security+': 'security+', 'securityplus': 'security+', 'sec+': 'security+',
    'comptia security+': 'security+', 'sy0-701': 'security+',
    'network+': 'network+', 'networkplus': 'network+', 'net+': 'network+', 'n10-009': 'network+',
    'a+': 'a+', 'aplus': 'a+', 'comptia a+': 'a+',
    'enem': 'enem',
    'cisa': 'cisa', 'cism': 'cism',
    'aws saa': 'aws-saa', 'aws solutions architect': 'aws-saa', 'saa-c03': 'aws-saa',
...
- Do NOT invent fake references or publication numbers`;
    ...
    const dedupSection = existingQuestions.length > 0
...
async function generateWithOpenAI(
    ...
    const systemPrompt = buildSystemPrompt(studyName, issuer, domains, targetDomainId, count, lang, existingQuestions);
...
export const POST = withAdmin(async (request: Request, { user, log }: RouteContext) => {
    ...
    if (parsed.studyId) {
        ...
        ctx = {
            ...
            issuer: enriched.issuer !== 'Unknown' ? enriched.issuer : (study.issuer || study.createdBy || 'Unknown'),
            domains: enriched.domains.length > 0 ? enriched.domains : firestoreDomains,
            isNewStudy: false,
        };
