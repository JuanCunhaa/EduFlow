...
import { getQuestion, updateQuestion, deleteQuestion, isQuestionInActiveExam } from '@/services/question-service';
...
export const GET = withAuth(async (request, { user, params }) => {
    ...
    const inActiveExam = await isQuestionInActiveExam(user.uid, params.questionId);
    if (inActiveExam) {
