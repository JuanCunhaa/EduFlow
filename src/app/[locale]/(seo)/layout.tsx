        ...
        <div className="seo-nav__inner">
          ...
          <nav className="seo-nav__links" aria-label="Certification navigation">
            {CERTS.slice(0, 3).map((cert) => (
              <Link
                key={cert.slug}
                href={`/${locale}/${cert.slug}`}
                className="seo-nav__link"
              >
                {cert.abbreviation}
              </Link>
            ))}
        ...
        <div className="seo-footer__inner">
          <div className="seo-footer__col">
            ...
            <ul>
              {CERTS.map((cert) => (
                <li key={cert.slug}>
                  <Link href={`/${locale}/${cert.slug}`}>
                    {cert.abbreviation} Practice
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div className="seo-footer__col">
            ...
            <ul>
              <li>
                <Link href={`/${locale}/cissp/practice-questions`}>
                  Free Practice Questions
                </Link>
              </li>
              <li>
                <Link
                  href={`/${locale}/cissp/domain-1-security-and-risk-management`}
                >
                  Study Guides
                </Link>
              </li>
