  ...
  return (
    <>
      ...
      <section className="seo-hero">
        ...
        >
          <Link
            href={`/${locale}/${cert.slug}/practice-questions`}
            className="seo-nav__cta"
          >
      ...
      <section className="seo-section">
        ...
        >
          <div className="seo-card">
            ...
            <p style={{ margin: 0 }}>
              Practice exams that automatically target your weak domains. Focus
              your study time where it matters most.
            </p>
          </div>
          <div className="seo-card">
            <h3 style={{ margin: '0 0 0.5rem' }}>🔄 Spaced Repetition</h3>
            <p style={{ margin: 0 }}>
              SM-2 algorithm schedules reviews at optimal intervals so you never
          ...
          <div className="seo-card">
            ...
            <p style={{ margin: 0 }}>
              Readiness score, domain weakness analysis, and a personalized
