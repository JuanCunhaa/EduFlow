...
export default async function BlogIndexPage({
  ...
  const structuredData = {
    ...
    description:
      'Expert tips and strategies for passing cybersecurity certifications.',
  ...
  return (
    <>
      ...
      <Breadcrumbs
        items={[{ label: 'Home', href: `/${locale}` }, { label: 'Blog' }]}
      />

      <section className="seo-hero">
        <h1>Cybersecurity Certification Blog</h1>
        <p>
          Expert strategies, study tips, and industry insights to help you pass
        ...
        <div className="seo-domain-list">
          {BLOG_POSTS.map((post) => (
            ...
            >
              ...
              <span
                className="seo-domain-item__name"
